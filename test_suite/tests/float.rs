...
mod derive_diesel_derive_newtype {
    ...
    fn test_diesel_derive_newtype() {
        ...
        let mut conn = prepare_database_table_for_type!(diesel_derive_newtype_test, "FLOAT");
        ...
        assert_eq!(inserted_obj.value.into_inner(), 12.345);
    }
}
